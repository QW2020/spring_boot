...
public class ShiroConfig {
    ...
    public SimpleCookie rememberMeCookie(){
        //这个参数是cookie的名称，对应前端的checkbox的name = rememberM
    ...
    /**
     *  记住我之cookie管理器，设置到CookieRememberMeManager，然后交给sfiro默认安全管理器
     */
    @Bean
     ...
     *  2、shiro默认Cookie名称是JSESSIONID，与servlet(jetty, tomcat等默认JSESSIONID
     *   我们需要为shiro指定一个不同名称的Session id，否则抛出UnknownSessionException
     *   There is no session with id异常
     *   当我们使用热部署重启应用时，已有的Session消失，shiro跳转到登录页面，也会抛出
     */
    @Bean
